    ...
    >
      ...
      >
        ...
        <div class="relative">
          ...
          <div class="pointer-events-none absolute right-[35%] top-0">
          ...
          >
            ...
            >
              ...
              <a
                ...
                aria-label="LinkedIn"
                class="mt-10 flex w-fit text-[#101014] transition-transform duration-300 hover:translate-x-2 dark:text-[#f8f7fa]"
              >

                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  class="h-7 w-7 transition-all duration-300 hover:scale-110 hover:text-[#ff3fa4]"
                  fill="currentColor"
                >
